...
class ProductProvider with ChangeNotifier {
  ...
  List<ProductModels> getProductByCat(String Category) {
    List<ProductModels> catList = _product
        .where((element) =>
            element.productCategory.toLowerCase() == Category.toLowerCase())
        .toList();
    return catList;
  }

  List<ProductModels> getProductBySearch(
      String name, List<ProductModels> list) {
    List<ProductModels> searchList = _product
        .where((element) =>
